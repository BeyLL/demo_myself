 ...
 * @Description: 主页面
 * @LastEditTime: 2021-02-08 09:15:29
 */
'use strict';
...
export default {
  ...
  effects: {
    ...
    *getMenu({ payload }, { put, call }) {
      ...
      const res = {
        ...
        data: [
          ...
          },
          {
            ...
            childId: null,
            menuSign: 'security-bigdata-1,security-bigdata-2',
            primaryName: 'asset_supervision6',
            router: null,
            auths: '0',
            orders: 1,
            createTime: '2019-08-29 18:06:14.0',
...

          {
            ...
            childId: null,
            menuSign: null,
            primaryName: 'patrol_task',
            router: null,
            auths: '',
            orders: 6,
            createTime: '2019-09-02 14:07:15.0',
            updateTime: '2021-02-02 15:56:10.0',
            own: null,
            menulever: null,
            identify: null,
            rlevel: '2',
...

          {
            ...
            resourceParentId: '',
            childId: null,
            menuSign: 'order-manage-1,order-manage-2',
            primaryName: 'asset_supervision7',
            router: null,
            auths: '0',
            orders: 9,
            createTime: '2019-08-29 18:06:14.0',
            updateTime: '2021-02-02 10:58:20.0',
            own: null,
            menulever: null,
            identify: null,
            rlevel: '1',
    ...
    //获取学生信息列表
    *getStudents({ payload }, { put, call, select }) {
    ...
    *getUsers({ payload }, { put, call, select }) {
    ...
    //   };
      ...
      if (result.success) yield put({ type: 'setState', payload: { account: result.data } });
    },
  },
